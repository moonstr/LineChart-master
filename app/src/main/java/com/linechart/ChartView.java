...
//        super.onDraw(canvas);
    ...
    private void drawGrid(Canvas canvas){
        ...
        //绘制y
        for (int i=0;i<30;i++){
            canvas.drawLine(xOri - xylinewidth / 2+gridW*i, 0, xOri - xylinewidth / 2+gridW*i, yOri, xyPaint);
        }
        //绘制x
        for (int i=0;i<10;i++){
            canvas.drawLine(xOri, yOri + xylinewidth / 2-gridW*i, width, yOri + xylinewidth / 2-gridW*i, xyPaint);
        }
    }
